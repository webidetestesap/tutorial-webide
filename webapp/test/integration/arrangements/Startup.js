sap.ui.define([
	"sap/ui/test/Opa5",
	"mySalesApplication/mySalesApplication/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("mySalesApplication.mySalesApplication.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "mySalesApplication.mySalesApplication",
					async: true
				},
				hash: oOptions.hash,
